            ...
            <form action="{{ route('admin.cars.update', $car->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="car_type" name="car_type" class="form-control" value="{{ $car->car_type }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="daily_rent_price">Daily Rent Price</label>
                        <input type="text" id="daily_rent_price" name="daily_rent_price" class="form-control" value="{{ $car->daily_rent_price }}" required>
                    </div>
                </div>
